...
{
	/**
	 * Testing the collision for the Car.
	 */
	@Test
	public void testCollisionCar()
	{
		 ...
		 *  Moving right
		 */
		carInstance.req_dx = 1; 
		/**
		 *  Not moving vertically
		 */
		carInstance.req_dy = 0; 
		...
		/**
		 *  Make the new position a house, causing a collision
		 */
		carInstance.levelData[newPos] = 0; 
	...
	/**
	 * Testing the collision for the passers.
	 */
	@Test
	public void testCollisionPassers() {
		...
		/**
		 *  Assuming there are 6 passers
		 */
		passersInstance.n_passers = 6; 
		/** * Sample passer positions */
		passersInstance.passer_x = new int[]{10, 20, 30, 40, 50, 60}; 
		passersInstance.passer_y = new int[]{10, 20, 30, 40, 50, 60};
		/** * Sample passer directions */
		passersInstance.passer_dx = new int[]{0, 0, 0, 0, 0, 0}; 
		passersInstance.passer_dy = new int[]{0, 0, 0, 0, 0, 0};
		/** * Sample passer speeds */
		passersInstance.passerSpeed = new int[]{1, 1, 1, 1, 1, 1}; 
		/** * Car position near a passer*/
		passersInstance.car_x = 15; 
